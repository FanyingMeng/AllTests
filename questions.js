const questionBank = {
  ...
  BASH_quiz03:[
  {
    "type": "fib",
    "question": "/home是什么",
    "answer": "contains personal subdirectories for users"
  },
  {
    "type": "fib",
    "question": "/etc是什么",
    "answer": "Contains system-wide configuration files and scripts."
  },
  {
    "type": "fib",
    "question": "/temp是什么",
    "answer": "Contains temporary files used by applications, cleared on reboot."
  },
  {
    "type": "fib",
    "question": "/var是什么",
    "answer": "Contains variable data files, for data that changes frequently"
  },
  {
    "type": "fib",
    "question": " / 是什么",
  ...
  },
  {
    "type": "fib",
    "question": " /boot 是什么",
    "answer": "Contains files needed to boot the system including kernel and bootloader configuration"
  },
  {
    "type": "fib",
    "question": " /bin 是什么",
    "answer": "command binaries (executables) needed for single user"
  },
  {
    "type": "fib",
    "question": " /sbin 是什么",
    "answer": "command binaries (executables) needed for root user"
  },
  {
    "type": "fib",
    "question": "开启screen的命令： ",
    "answer": "screen"
  },
  { 
    "type": "fib", 
    "question": "退出screen session：两个 ",
    "answer": "exit 或 Ctrl + D"
  },
  {
    "type": "fib",
    "question": "列出当前所有的 screen 会话状态： ",
    "answer": "screen -ls"
  },
  {
    "type": "fib", 
  ...
  { 
    "type": "fib", 
    "question": "恢复ID为1234的会话： ",
    "answer": "screen -r 1234"
  },
  { 
    "type": "fib", 
    "question": "查看当前进程： ",
  ...
  { 
    "type": "fib", 
    "question": "建立一个暂停60s后台跑的会话： ",
    "answer": "screen -dm sleep 60"
  },
  { 
    "type": "fib", 
    "question": "建立一个名叫s1的会话，运行暂停60s的后台跑的任务： ",
    "answer": "screen -dmS s1 sleep 60"
  },
  { 
    "type": "fib", 
    "question": "给f1.txt建立一个hard link叫做f2.txt： ",
    "answer": "ln f1.txt f2.txt"
  },
  { 
    "type": "fib", 
    "question": "给f1.txt建立一个soft link叫做f2.txt： ",
    "answer": "ln -s f1.txt f2.txt"
  },
  { 
    "type": "fib", 
    "question": "结束一个PID为1234的进程： ",
    "answer": "kill 1234"
  },
  { 
    "type": "fib", 
    "question": "强制终止一个PID为1234的进程： ",
    "answer": "kill -9 1234"
  },
  { 
    "type": "fib", 
